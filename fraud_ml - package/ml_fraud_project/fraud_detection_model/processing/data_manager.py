...
def load_dataset(*, file_name: str) -> pd.DataFrame:
    dataframe = pd.read_csv(Path("{}/{}.csv".format(DATASET_DIR, file_name)))
...
def save_pipeline(*, pipeline_to_persist: Pipeline) -> None:
    ...
    Saves the versioned model, and overwrites any previous saved model.
    ...
    save_file_name = "{}{}.pkl".format(config.app_config.pipeline_save_file, _version)
...
def remove_old_pipelines(*, files_to_keep: t.List[str]) -> None:
    ...
    the package version and the model version to be imported and used by other applications.
    """
