...
pipeline_file_name = "{}{}.pkl".format(config.app_config.pipeline_save_file, _version)

_fraud_pipe = load_pipeline(file_name=pipeline_file_name)
...
def make_prediction(
    *,
    ...
    if not errors:
        predictions = _fraud_pipe.predict(
